...
class ResultObjectBoxWidget extends StatefulWidget {
  ...
  @override
  _ResultObjectBoxWidgetState createState() => _ResultObjectBoxWidgetState();
}

class _ResultObjectBoxWidgetState extends State<ResultObjectBoxWidget> {
  @override
