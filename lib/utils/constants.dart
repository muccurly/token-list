...
List<Map<String, dynamic>> REVIEWS = [
  ...
  },
  {
    ...
    'text':
        'Огромная благодарность агентству\ntest\n недвижимости и лично специалисту Темирлану Умурзакову за высокий профессионализм в подборе жилья, безупречную организацию работы, надежность и нацеленность на результат!'
  },
];
